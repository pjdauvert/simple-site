...
vi.mock('../../hooks/useFeatureFlags', () => ({ useFeatureFlags: vi.fn(), ALL_DISABLED: { media: false, team: false, contact: false, gallery: false } }));
...
describe('SiteConfigPage', () => {
  beforeEach(() => {
    ...
    vi.mocked(useFeatureFlags).mockReturnValue({ media: true, team: false, contact: false, gallery: false });
  });
