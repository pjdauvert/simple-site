import { MenuItemSchema } from "./menu.interface.js";
import { z } from "zod";
import { type HeroSectionProps, type TextSectionProps, HeroSectionPropsSchema, TextSectionPropsSchema, SectionTypeSchema, SectionTypesEnum } from "./sections/index.js";

type SectionTypeValue = z.infer<typeof SectionTypeSchema>;
