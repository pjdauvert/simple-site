...
- **`design.itemMaxWidth`** (optional) — caps each item's clickable image at this width in px (100–2400), in **every** display mode; absent → the mode's natural width (full column/cell). The zoom view is unaffected — it keeps maximising to the screen.
